...
const projects = [
  ...
  },
  {
    ...
    description:
      'Interactive weather data visualization with historical trends and forecasting capabilities.',
  ...
  },
  {
    ...
    description:
      'Machine learning-powered analytics platform for business intelligence and data insights.',
